...
CREATE TABLE public.period_recurrencies (
    value text NOT NULL,
    description text NOT NULL
);
...
CREATE TABLE public.reminders_frequencies (
    value text NOT NULL,
    description text NOT NULL
);
...
ALTER TABLE ONLY public.reminders_frequencies
    ADD CONSTRAINT notification_frequencies_pkey PRIMARY KEY (value);
...
ALTER TABLE ONLY public.period_recurrencies
...
ALTER TABLE ONLY public.groups
    ADD CONSTRAINT groups_recurrency_fkey FOREIGN KEY (recurrency) REFERENCES public.period_recurrencies(value) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.invitations
...
ALTER TABLE ONLY public.members
    ADD CONSTRAINT members_notification_frequency_fkey FOREIGN KEY (reminders_frequency) REFERENCES public.reminders_frequencies(value) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.members
    ADD CONSTRAINT members_recurrency_fkey FOREIGN KEY (recurrency) REFERENCES public.period_recurrencies(value) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.members
...
INSERT INTO public.period_recurrencies (value, description) VALUES ('DAILY', 'Daily');
INSERT INTO public.period_recurrencies (value, description) VALUES ('WEEKLY', 'Weekly');
INSERT INTO public.period_recurrencies (value, description) VALUES ('MONTHLY', 'Monthly');
INSERT INTO public.reminders_frequencies (value, description) VALUES ('LOW', 'Low');
INSERT INTO public.reminders_frequencies (value, description) VALUES ('NORMAL', 'Normal');
INSERT INTO public.reminders_frequencies (value, description) VALUES ('HIGH', 'High');
INSERT INTO public.reminders_frequencies (value, description) VALUES ('VERY_HIGH', 'Very high');
